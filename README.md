...
**_17/06/2025_: The application unfortunately does not work anymore, due to some major changes in Spotify's API since 2021. I forked Spotify-TUI because I'm going to attempt updating the application to work with Spotify's updated API.**
